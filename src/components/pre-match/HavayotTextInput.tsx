...
Let's update the design of the HavayotTextInput component to match the requested specifications while maintaining RTL support and existing functionality.

<lov-code>
First, let's update the HavayotTextInput component with the new design:

<lov-write file_path="src/components/pre-match/HavayotTextInput.tsx">
import { useState } from "react";
import { Button } from "@/components/ui/button";
import { Textarea } from "@/components/ui/textarea";
import { HavayotPopup } from "@/components/havayot/HavayotPopup";
