...
export const HavayotManager = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 max-w-4xl mx-auto">
      <Button
        variant="outline"
        className="h-24 md:h-32 bg-gradient-to-r from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100 transition-all hover:scale-[1.02] shadow-sm"
      ...
      <Button
        variant="outline"
        className="h-24 md:h-32 bg-gradient-to-r from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100 transition-all hover:scale-[1.02] shadow-sm"
      ...
      <Button
        variant="outline"
        className="h-24 md:h-32 bg-gradient-to-r from-yellow-50 to-amber-50 hover:from-yellow-100 hover:to-amber-100 transition-all hover:scale-[1.02] shadow-sm"
      ...
      <Button
        variant="outline"
        className="h-24 md:h-32 bg-gradient-to-r from-purple-50 to-pink-50 hover:from-purple-100 hover:to-pink-100 transition-all hover:scale-[1.02] shadow-sm"
